...
public class BookStoreAuthServerModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "df747681-f73b-4a9e-8fee-d1a428987752");
            });
        }
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            builder.AddServer(x =>
            {
                x.SetAccessTokenLifetime(TimeSpan.FromSeconds(5));
            });
        });
    }
